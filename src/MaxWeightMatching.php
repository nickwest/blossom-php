...
class MaxWeightMatching
{
    ...
    */
    ...
    public $check_delta = true;

    # Check optimality of solution before returning; only works on integer weights.
    public $check_optimum = true;

    # If assigned, $this->debug(str) is called with lots of debug messages.
    public $debug = false;
    // public $this->debug = function($s) {
    //     error_log("DEBUG: $s");
    // };
